...
interface IndividualProjectPageDonatedProps{
  donorID: number
}

const IndividualProjectPageDonated = (props:IndividualProjectPageDonatedProps) => {
  ...
  <Grid item xs={8}>
      <Stack spacing={5} height="fit-content">
          ...
          <Stack spacing= {4}>
            <h2>Key Goals and Progress Update</h2>

            {/* Need to change this to putline  */}
            <Stack spacing ={2}>
             <h3>Latest Progress Report from the Charity</h3>
             <Stack padding = {2} border = {1}>
                <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut quis iaculis et velit. Tristique viverra mauris nibh tortor. Lacinia viverra elementum quis id arcu sit sed aliquet at. Rutrum tincidunt purus ut velit, egestas amet eu, sagittis, sit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut quis iaculis et velit. Tristique viverra mauris nibh tortor. Lacinia viverra elementum quis id arcu sit sed aliquet at. Rutrum tincidunt purus ut velit, egestas amet eu, sagittis, sit.</p>

                <ImageList sx={{height: 500}} cols={1} rowHeight={400}>
                    <ImageListItem>
                      <img src = 'https://dqelp6tva12fr.cloudfront.net/original_images/charities.jpg' alt="people unpacking donation boxes"/> 
                    </ImageListItem>
                    <ImageListItem>
  ...
  <Grid item xs={4} >
    <Stack spacing = {2}>
      ...
      <Card id ='side-column-card-emphasize'>
          <Stack spacing = {2}>
              <p>Your Donated</p>
              <h2 style={{color: "white"}} >75000 USD</h2>
          </Stack>
...
export default IndividualProjectPageDonated;