...
interface IndividualProjectPageManageProps{
  donorID: number
}

const IndividualProjectPageManage = (props:IndividualProjectPageManageProps) => {
...
export default IndividualProjectPageManage;